...
import { Vimeo, ResizedImageWithCaption } from '@/components/partials';
import instructions from './images/instructions.png';
import HandHeld from './images/HandHeld-1.jpg';
import FannyPack from './images/FannyPack-1.jpg';
import Prototype from './images/prototype.jpg';
import DeviceBack from './images/DeviceBack-1.jpg';
import baristaEncounter from './images/baristaEncounter.jpg';
import classic from './images/classic-vs-self-driving-dan-bar.png';

export const meta = {
  title: 'The Self-Driving Human',
  date: Date.parse('2019-05-20T22:52:10-04:00'),
  draft: false,
  animatedImage: require('./images/self_driving_human.gif'),
  image: require('./images/self-driving-human-image.jpg'),
  weight: 1,
  image: 'images/',
  aliases: ['self-driving-human'],
  summary:
...
<ResizedImageWithCaption src={instructions} caption="Basic decision the device can make" />
...
<ResizedImageWithCaption src={HandHeld} caption="Hand-held prototype" />
...
<ResizedImageWithCaption
  src={FannyPack}
  caption="It can fit into a fanny pack with a spy camera observing the environment"
/>
...
<ResizedImageWithCaption src={Prototype} caption="Initial prototype" />

<ResizedImageWithCaption
  src={DeviceBack}
  caption="Version of the device with the camera attached directly to the enclosure"
/>

<ResizedImageWithCaption src={baristaEncounter} caption="Asking: 'how's your day going' to a barista" />

<ResizedImageWithCaption
  src={classic}
  caption="What should I do in a bar?  Let's compare the Classic Dan vs. the New Self-Driving Dan as instructed by the device."
/>
